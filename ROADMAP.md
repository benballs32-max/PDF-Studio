...
- [ ] Add / replace / resize images within a PDF
- [ ] Watermarks (text or image, applied to all pages)
- [ ] Stamps — APPROVED / DRAFT / CONFIDENTIAL / COPY etc.
- [ ] Headers & footers across all pages
- [ ] Page numbering
